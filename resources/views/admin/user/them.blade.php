        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="admin/user/them" method="POST">
                    ...
                    <div class="form-group">
                        <label>Adress</label>
                        <input class="form-control" name="address" placeholder="Please Enter Category Adess" />
                    </div>
                    <div class="form-group">
                        <label>phone</label>
                        <input class="form-control" name="phone" placeholder="Please Enter Category phone number" />
                    </div>
                    <div class="form-group">
